...
@MenuItem ("Window/Save Texture  5.2.3+ %#t")
	...
	if (Selection.activeObject)
	{
		if (Selection.activeObject.GetType() == UnityEditor.SubstanceArchive)
		{
			...
			//{
				...
				SFB_Exporter_5_2_3.SFB_Export(substanceImporter, substanceMaterials, basePath, substance, code);
			//}
		}
	}
}

    @MenuItem ("Window/Save Texture 5.2.3+", true)
